...
const StoriesNigeriaPastPage = () => {
  ...
  const isCurrentPage = (item) => {
    ...
    if (item === 'Current Affairs' && (location.pathname === '/current-affairs' || location.pathname === '/StoriesNigeriaPastPage')) return true;
  ...
  const generateStoryCards = () => {
    ...
    const stories = [
      'How Did the Biafra War Frame Today\'s Political Landscape',
      'The Unspoken Horrors of the Transatlantic Slave Trade',
      'The Hidden Agenda behind the Famous Amalgamation'
    ];

    for (let i = 0; i < totalCards; i++) {
      const storyTitle = stories[i % 3];
      cards.push(
        <div key={i} className="flex flex-col items-center">
          ...
          >
            ...
            <div className="p-4 text-center">
              <h3 className="font-semibold text-lg text-black mb-2">{storyTitle}</h3>
              <button
                onClick={() => handleReadMore(i + 1)}
                className="bg-black text-white w-40 py-2 text-sm rounded hover:bg-gray-800 hover:border-2 hover:border-green-500 transition-all mt-auto cursor-pointer"
              >
                Read more
              </button>
            </div>
      ...
      <header className="bg-white shadow-sm fixed top-0 left-0 right-0 z-50 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            {/* CTA Button */}
            <button className="hidden lg:block bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700 transition-colors">
              SUBSCRIBE
            </button>
      ...
      <main className="py-16 pt-20 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-black mb-4">Stories from Nigeria's Past</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a className="text-gray-300 hover:text-green-500 transition-colors text-sm cursor-pointer">History</a></li>
                <li><a className="text-gray-300 hover:text-green-500 transition-colors text-sm cursor-pointer">Contact us</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col space-y-2">
                ...
                />
                <button className="bg-green-600 px-4 py-2 rounded hover:bg-green-700 transition-colors w-fit">
                  Subscribe
                </button>
              </div>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 mt-8">
            <p className="text-center text-white text-sm">
              © 2025 OrderPaper. All Rights Reserved.
            </p>
          </div>
        </div>
      </footer>
...
export default StoriesNigeriaPastPage;