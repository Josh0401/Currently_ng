...
const NigerianPresidentsPage = () => {
  ...
  const isCurrentPage = (item) => {
    ...
    if (item === 'Current Affairs' && (location.pathname === '/current-affairs' || location.pathname === '/nigerian-presidents')) return true;
    if (item === 'Blog' && location.pathname === '/blog') return true;
    return false;
  };

  const handleReadMore = (presidentId) => {
    navigate(`/president-detail/${presidentId}`);
  };

  const generatePresidentCards = () => {
    const cards = [];
    const totalCards = 12;
        ...
        <div key={i} className="flex flex-col items-center">
          ...
          >
            ...
            <div className="p-4 text-center">
              <h3 className="font-semibold text-lg text-black mb-1">President's Name</h3>
              <p className="text-gray-600 text-sm mb-4">Date Duration</p>
              <button
      ...
      <main className="py-16 pt-20 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-black mb-4">Nigerian Presidents Till Date</h1>
...
export default NigerianPresidentsPage;